...
import PROYECTOEDD2022.Programa.Logica;
	...
	private void initialize() {
		...
		btnEliminarNodo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(tag.length()==0)
					...
					}catch (PROYECTOEDD2022.Exceptions.InvalidPositionException e1) {textAreaNotifications.setText(e1.getMessage());}
				}
				if(main.size() == 0) {
		...
		btnRecorridoPreOrden.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				textAreaNotifications.setText(main.stringenaizer(main.preOrden()));
			}
		...
		btnRecorridoPostOrden.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				textAreaNotifications.setText("");
				textAreaNotifications.setText(main.stringenaizer(main.postOrden()));
			}
		});
		...
		btnRecorridoPorNiveles.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				textAreaNotifications.setText("");
				textAreaNotifications.setText(main.stringenaizer(main.recorridoPorNiveles()));
