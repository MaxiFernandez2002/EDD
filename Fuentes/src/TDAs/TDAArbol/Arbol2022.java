...
public class Arbol2022<E> implements Tree<E>{
	...
	public Position<E> addBefore(Position<E> p, Position<E> rb, E e) throws InvalidPositionException {
		...
		try {
		PROYECTOEDD2022.TDAs.TDALista.Position<TNodo<E>> pp = hijos.first();
	...
	public Position<E> addAfter(Position<E> p, Position<E> lb, E e) throws InvalidPositionException {
		...
		try {
			PROYECTOEDD2022.TDAs.TDALista.Position<TNodo<E>> aux = hijos.first();
	...
	public void removeExternalNode(Position<E> p) throws InvalidPositionException {
		...
		PROYECTOEDD2022.TDAs.TDALista.Position<TNodo<E>> pp = null;
		Iterable<PROYECTOEDD2022.TDAs.TDALista.Position<TNodo<E>>> posiciones = hijosPadre.positions();
		Iterator<PROYECTOEDD2022.TDAs.TDALista.Position<TNodo<E>>> it = posiciones.iterator();
	...
	public void removeInternalNode(Position<E> p) throws InvalidPositionException {
		...
		if(isRoot(p))
			...
			try {
			 PROYECTOEDD2022.TDAs.TDALista.Position<TNodo<E>> posDeN;
			 PROYECTOEDD2022.TDAs.TDALista.Position<TNodo<E>> cursor = hPadre.first();
				...
				while(!hN.isEmpty()) {
					PROYECTOEDD2022.TDAs.TDALista.Position<TNodo<E>> hijoN = hN.first();
	...
	protected void removeRoot(Position<E> p) throws InvalidPositionException{
		...
		try {
			...
			{
				PROYECTOEDD2022.TDAs.TDALista.Position<TNodo<E>> rN = root.getHijos().first();
	...
	/**
	 * Metodo privado que chequea que la posicion pasada por parametro sea valida, y la castea a TNodo.
