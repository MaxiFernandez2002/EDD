package PROYECTOEDD2022.TDAs.TDACola;

import PROYECTOEDD2022.Exceptions.EmptyQueueException;
...
public class ColaConArregloCircular <E> implements Queue <E>
{
	...
	/**
	 * Metodo privado que duplica el tamanio del arreglo de la cola circular, e inserta en el los elementos que contenia 
	 * anteriormente
