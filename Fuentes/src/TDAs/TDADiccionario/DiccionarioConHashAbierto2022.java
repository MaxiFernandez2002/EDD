package PROYECTOEDD2022.TDAs.TDADiccionario;
import PROYECTOEDD2022.Exceptions.*;
import PROYECTOEDD2022.TDAs.TDALista.ListaDoblementeEnlazada2022;
import PROYECTOEDD2022.TDAs.TDALista.Position;
import PROYECTOEDD2022.TDAs.TDALista.PositionList;
...
public class DiccionarioConHashAbierto2022<K,V> implements Dictionary<K,V> {
	...
	/**
	 * Constructor de la clase DiccionarioConHashAbierto.
	 * Crea una nueva tabla de hash.
	 * Inicializa los atributos de instancia y rellena el arreglo 
	 */
	 ...
	 * Redimensiona el tamaño del arreglo para que no haya un factor de carga actual mayo a 0.9f
	 */
	@SuppressWarnings({ "unchecked" })
	private void reHash() {
